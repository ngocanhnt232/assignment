          ...
          <div class="row">
            <div class="col-md-12 mb-3">
                <div>
                    ...
                    <input class="form-control" id="first_name" type="number" placeholder="Nhập giá" name="price" >
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
              <div>
                  ...
                  <input class="form-control" id="first_name" type="text" placeholder="Nhập số lượng" name="quantity" >
              </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-12 mb-3">
              <div>
                  ...
                  <input class="form-control" id="first_name" type="number" placeholder="Nhập mã giảm giá" name="discount" >
              </div>
          </div>
        </div>
            <div class="mt-3">
