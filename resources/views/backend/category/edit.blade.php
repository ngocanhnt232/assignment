            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="first_name" type="text" placeholder="Nhập tên" name="name" value="{{$category->name}}">
                    </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-12 mb-3">
                  <div>
                      ...
                      <input class="form-control" id="first_name" type="text" placeholder="Nhập mô tả" name="description" value="{{$category->description}}">
                  </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12 mb-3">
                  <div>
                      ...
                      <img src="https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg" alt="" id="image_preview" width="100" value="{{$category->image}}">
                  </div>
              </div>
          </div>
            <div class="mt-3">
